/*
  ...
  1. Tours Table
    - Complete tour information with all required fields
    - Media storage (images and videos)
    - Itinerary management with JSONB
    - Pricing and booking details
    - Admin workflow and approval system
    - SEO and marketing features

  2. Storage Buckets
    - `tour-media` bucket for images and videos
  ...
  4. Performance
    ...
    - Efficient JSONB storage for itinerary
...
INSERT INTO tours (
  title, location, duration, description, price, original_price,
  group_size, difficulty, category, highlights, includes, excludes,
  itinerary, images, videos, created_by, is_active, featured
) VALUES (
  'Golden Triangle Heritage Tour',
  'Delhi - Agra - Jaipur',
  '6 Days / 5 Nights',
  'Experience India''s most iconic destinations in this comprehensive 6-day journey through the Golden Triangle.',
  25000,
  30000,
  'Max 15 people',
  'Easy',
  'Cultural',
  ARRAY['Taj Mahal at Sunrise', 'Red Fort Delhi', 'Hawa Mahal Jaipur', 'Amber Fort', 'Local Markets', 'Traditional Cuisine'],
  ARRAY['5-star Accommodation', 'All Meals', 'Private Transport', 'Expert Guide', 'Entry Tickets', 'Airport Transfers'],
  ...
  ARRAY['https://images.pexels.com/photos/1583339/pexels-photo-1583339.jpeg'],
  ARRAY[]::TEXT[],
